                ...
                if line:
                    ...
                    for websocket in log_connections:
                        try:
                            ...
                            handle_websocket_error(e, websocket, {'action': 'send_log_data', 'phase': phase})
...
async def websocket_logs(websocket: WebSocket):
    ...
    logger.info("New WebSocket connection for logs")
    ...
    try:
        ...
        log_connections.discard(websocket)  # Use discard to avoid KeyError if already removed
