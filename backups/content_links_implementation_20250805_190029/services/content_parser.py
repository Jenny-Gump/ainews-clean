...
class ContentParser:
    ...
    async def _save_article_content(self, article_id: str, extracted_data: Dict[str, Any]) -> bool:
        """
        ...
        try:
            with self.db.get_connection() as conn:
                ...
                # Update media count
                conn.execute("""
                    UPDATE articles SET media_count = ? WHERE article_id = ?
                """, (media_count, article_id))
    ...
    async def parse_article(self, article_id: str, url: str, source_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Save to database
            save_success = await self._save_article_content(article_id, extracted_data)
