...
class Database:
    ...
    def update_article_content(self, article_id: str, content_data: Dict):
        ...
        with self.get_connection() as conn:
            ...
            values.extend([content_data.get('content'), 'completed'])
    ...
    def insert_media(self, media: Dict) -> Optional[str]:
        ...
        media_id = self.generate_media_id(media['article_id'], media['url'])
    ...
    def get_parsing_statistics(self) -> Dict:
        ...
        with self.get_connection() as conn:
            ...
            stats['completed_articles'] = status_counts.get('completed', 0)
            ...
            cursor.execute("""
                SELECT 
                    COUNT(CASE WHEN content_status = 'completed' THEN 1 END) as completed_today,
